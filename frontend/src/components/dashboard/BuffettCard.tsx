...
function Sparkline({
  ...
  /** Each point — label (year string) shown on x-axis and tooltip header */
  data: { value: number; label?: string }[]
  color: string
  height?: number
  /** Formats the hover tooltip value — e.g. (v) => '
...
export function BuffettCard({ height, onResizeMouseDown }: BuffettCardProps) {
      ...
      <div className="flex-1 overflow-auto min-h-0">
        {!ticker ? (
          ...
          <div className="py-4 space-y-5">
            ...
            {/* ── Rules 1 & 4: metric snapshot — side-by-side, no charts ── */}
  ...
  // Reserve extra vertical space for x-axis tick labels when present
